...
""""
The number t of squarings required to solve the puzzle can be exactly controlled. 
Thus we can create puzzles of various desired levels of difficulty.
"""
...
def generate_keys(seed, iNumBits, iConfidence=32):
    ...
    publicKey = PublicKey(p, g, h, iNumBits=iNumBits)
    #privateKey = PrivateKey(p, g, x, iNumBits=iNumBits)
...
if __name__ == '__main__':
	...
	difficulty = 20
	pub = generate_keys(seed=833050814021254693158343911234888353695402778102174580258852673738983005, iNumBits=difficulty)
